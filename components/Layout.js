...
function Layout({ children, meta }) {
  ...
  return (
    <React.Fragment>
      <Meta {...meta}></Meta>
      <nav>
        <div className="bg-gradient-to-r from-green-500 via-sky-400 to-pink-400 h-0.5"></div>
        <div className={navClass}>
          <div className="px-5 md:px-0 w-full md:w-1/2   h-full flex items-center justify-between">
            ...
            <div className="hidden md:flex h-full">
              ...
              <MenuItem href="/tips">ProTips</MenuItem>
            </div>
            {show ? (
        ...
        {show ? (
          <div className="relative z-10">
            <div className="border-b flex flex-col shadow-sm absolute w-full bg-white">
              ...
              <MenuItemMobile href="/tips">ProTips</MenuItemMobile>
            </div>
          </div>
        ) : null}
      </nav>
