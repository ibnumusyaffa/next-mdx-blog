...
In the previous article, we have learned about the [Input/Output pattern](/blog/thinking-in-functions) and how to use it when writing functions Today I'd like to continue the series by talking about one of the most powerful concepts of functional programming—higher-order functions.asasaasasa
